...
data = pd.DataFrame(columns = ['phi', 'psis', 'alphas', 'betas', 'beta_hats','beta_tildes','beta_bars','sigmas','etas','lambdas','eta_bars','mus','ds_dr',
                               'de_dr','de_dg','dg_dF','dg_dy','dp_dy','db_de','da_dr','dq_da','da_dp','dp_dH','dc_dw_p','dc_dw_n','dl_dx','du_dx',
